...
<body>
	...
	<table>
		...
		<tr>
			<th class="th_classinfo">Classloaders</th>
 ...
 %>
		...
		<tr>
			<th class="th_classinfo">File Name</th>
			<td class="td_classinfo"><%=classInfo.get("X_FILE_NAME")%></td>
		</tr>
		<tr>
			<th class="th_classinfo">Modified Date</th>
			<td class="td_classinfo"><%=classInfo.get("X_FILE_DATE")%></td>
		</tr>
	</table>
	</p>
	<%
	...
	<table>
		<tr>
			<th class="th_classloader">Boot Classes (from
				sun.boot.class.path)</th>
		</tr>
		<%
	...
	<table>
		<tr>
			<th class="th_classloader">Extension Classes (from
				java.ext.dirs)</th>
		</tr>
		<%
	...
	<table>
		<tr>
			<th class="th_classloader">Application Classes (from
				java.class.path)</th>
		</tr>
		<%
